...
<img src="./phrase.svg" width="100%" alt="The closer you look, the less you see."/>
...
- **[log-analyzer](https://github.com/ispectr3/log-analyzer)** — Bash log parser for Apache, Nginx and SSH with HTML report generation.
...
- **[log-analyzer](https://github.com/ispectr3/log-analyzer)** — Parser de logs em Bash para Apache, Nginx e SSH com geração de relatórios em HTML.
